function [Hleft,Hright,Fleft,Fright,Pleft,Pright]=edgefilters(h0,h1,f0,f1);
...
for i=1:nl
  for j=i+1:nl
%    Pright(:,[i j])=lpa(Pright(:,i),Pright(:,j));
  end
end
...
function h=rotatefilterright(h)
